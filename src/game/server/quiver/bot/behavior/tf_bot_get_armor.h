...
#ifndef TF_BOT_GET_ARMOR_H
#define TF_BOT_GET_ARMOR_H

#include "tf_powerup.h"

class CTFBotGetArmor : public Action< CTFBot >
{
public:
	...
	virtual const char *GetName( void ) const	{ return "GetArmor"; };

private:
	PathFollower m_path;
	CHandle< CBaseEntity > m_Armor;
