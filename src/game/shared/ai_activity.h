...
#ifdef BDSBASE
	// Survivor!
	// We should really consider only using these for SURVIVOR II, but it's better to allow these animations for all mods
	// in case other mods need to use HL2 Survivor's animation set.
